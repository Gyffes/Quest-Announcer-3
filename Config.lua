...
local function RefreshGeneralPanel()
    ...
    profileDropdown:SetPoint("TOPLEFT", profilePanel, "TOPLEFT", 300, -72)
    ...
    profileOverviewHeader:SetPoint("TOPLEFT", profilePanel, "TOPLEFT", 16, -180)
    ...
    overviewBackground:SetSize(760, 270)
    ...
    profileOverviewText:SetWidth(740)
